## POST /api/groups/{groupId}/join-requests/{requestId}/decline – Error Flow
```mermaid
flowchart TD
    A[POST<br/>/api/groups/:groupId/join-requests/:requestId/decline] --> B{Authenticated?}
